class Event < ActiveRecord::Base
  ...
  validates :host_id, :date, :date_date, :date_time, :location, :description, :menu, :price_in_pennies, :currency, presence: true
  validates :price, numericality: { greater_than: 0 }
  validates :seats, numericality: { only_integer: true, greater_than: 0 }, presence: true
