...
describe User do
  ...
  describe "states" do
    context "unsuccessfully signed up" do
      it { expect(User.new.state).to eq "profile_incomplete" }
    end

    context "successfully signed up from devise" do
      it { expect(FactoryGirl.build(:user_without_profile).state).to eq "devise_complete" }
    end

    context "successfully signed up from devise and has completed their profile" do
  ...
  describe "transitions" do
    describe "complete_devise" do
      ...
      context "signed up from devise" do
        subject { FactoryGirl.create(:user_without_profile) }
        it { expect { subject.complete_devise }.to_not change { subject.state } }
      end
    ...
    describe "complete_profile" do
      context "profile_incomplete" do
        subject { User.new }
        it { expect { subject.complete_profile }.to_not change { subject.state } }
      end
